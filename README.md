...
Ahora, necesitamos organizar y tener en cuenta todos los documentos y bases de datos que vamos a necesitar organizar para ejecutar todo el documento. Todo lo que necesitamos esta en esta carpeta y ya todas las rutas estan para que funcione solo en este drive:https://drive.google.com/drive/folders/1IpXy65wyVVcIRdlz9IuSRqXiLV4kGPwJ?usp=sharing

Ahi se van a encontrar los siguientes archivos:
...
Tres carpetas con la informacion de tres sistemas satelitales llamados Modis, NOA20 y Suomi que son los archivos principales descargados desde NASA FIRMS para corroborar que los incendios de nuestra base de datos (inventario de casos) si esten registrados en la base datos la NASA. (2.2 millones de datos en total)
